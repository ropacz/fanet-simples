#
# OMNeT++/OMNEST Makefile for fanet-simples
#
...
INCLUDE_PATH = -I/Users/rodrigo/omnetpp-workspace/inet-4.5.4/src

# Additional object and library files to link with
EXTRA_OBJS =

# Additional libraries (-L, -l options)
LIBS = $(LDFLAG_LIBPATH)/Users/rodrigo/omnetpp-workspace/inet-4.5.4/src  -lINET
...
OBJS = $O/src/Aircraft.o $O/src/ArbitraryMobility.o $O/src/FANETApp.o
...
LIBS += -Wl,-rpath,$(abspath /Users/rodrigo/omnetpp-workspace/inet-4.5.4/src)
endif
